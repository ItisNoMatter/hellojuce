...
//==============================================================================
const juce::String HelloJUCEAudioProcessor::getName() const
{
...
bool HelloJUCEAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
const juce::String HelloJUCEAudioProcessor::getProgramName (int index)
{
    return {};
}

void HelloJUCEAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool HelloJUCEAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void HelloJUCEAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* HelloJUCEAudioProcessor::createEditor()
{
    return new HelloJUCEAudioProcessorEditor (*this);
}

//==============================================================================
void HelloJUCEAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
